...
const yOffset = 80 + (j * 360);
                    ...
                    if (imgElement) {
                        pdf.addImage(imgElement, 'PNG', (pageWidth/2)-95, yOffset + 20, 190, 190);
                    ...
                    letras.forEach((letra, idx) => {
                        if (ej.huecos.includes(idx)) {
                            ...
                            pdf.setLineWidth(2);
                           pdf.line(startX, yOffset + 270, startX + 30, yOffset + 270);

                        } else {
                            pdf.setTextColor(30, 41, 59);
                            pdf.text(letra, startX + 5, yOffset + 265)
                        }
                        startX += 45;
                    });
                    ...
                    ej.opciones.forEach(opt => {
                       ...
                       pdf.circle(optX + 20, yOffset + 325, 20, 'S');
                        pdf.setLineDashPattern([], 0);
                        pdf.setTextColor(30, 41, 59);
                        pdf.setFontSize(18);
                        pdf.text(opt, optX + 13, yOffset + 332);
                        optX += 60;
                    });
                    contadorGlobal++;
                }
